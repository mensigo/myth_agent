...
Defines the browser chat experience and the server-side boundary that keeps the Anthropic API key private while streaming tutor responses to the learner.
